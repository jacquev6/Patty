...
def post_textbook(
    ...
    if single_pdf_file is not None:
        ...
        pdf_file_range = extraction.PdfFileRange(
            ...
            first_page_number=req.single_pdf.pdf_first_page_number,
            pages_count=req.single_pdf.pages_count,
        )
        ...
        extraction_batch = textbooks.TextbookExtractionBatch(
            ...
            textbook=textbook,
            first_textbook_page_number=req.single_pdf.textbook_first_page_number,
...
async def get_textbook(id: str, session: database_utils.SessionDependable) -> GetTextbookResponse:
    ...
    return GetTextbookResponse(
        ...
        ranges=ranges,
        single_pdf=textbook.single_pdf_file is not None,
    )
