...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["exercise_adaptation_settings.id"],
            name=op.f("fk_exercise_classes_latest_strategy_settings_id_exercise_adaptation_settings"),
            use_alter=True,
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_classes")),
    )
    op.create_table(
        "exercise_classification_chunks",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("model_for_adaptation", sa.JSON(), nullable=True),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_classification_chunks")),
    )
    op.create_table(
        "exercises",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["exercise_class_id"],
            ["exercise_classes.id"],
            name=op.f("fk_exercise_adaptation_settings_exercise_class_id_exercise_classes"),
        ),
        sa.ForeignKeyConstraint(
            ["parent_id"],
            ["exercise_adaptation_settings.id"],
            name=op.f("fk_exercise_adaptation_settings_parent_id_exercise_adaptation_settings"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_adaptation_settings")),
    )
    op.create_table(
    ...
    op.create_table(
        "exercise_classification_chunk_creations",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("kind", sa.String(), nullable=False),
        sa.Column("at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["id"],
            ["exercise_classification_chunks.id"],
            name=op.f("fk_exercise_classification_chunk_creations_id_exercise_classification_chunks"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_classification_chunk_creations")),
    )
    op.create_table(
        "exercise_creations",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_exercise_adaptations_exercise_id_exercises__adaptable"),
        ),
        sa.ForeignKeyConstraint(
            ["settings_id"],
            ["exercise_adaptation_settings.id"],
            name=op.f("fk_exercise_adaptations_settings_id_exercise_adaptation_settings"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_adaptations")),
    )
    op.create_table(
        "exercise_class_creations__by_classification_chunk",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["exercise_classification_chunks.id"],
            name=op.f(
                "fk_exercise_class_creations__by_classification_chunk_classification_chunk_id_exercise_classification_chunks"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["id"],
            ["exercise_class_creations.id"],
            name=op.f("fk_exercise_class_creations__by_classification_chunk_id_exercise_class_creations"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_class_creations__by_classification_chunk")),
    )
    op.create_table(
    ...
    op.create_table(
        "exercise_classification_chunk_creations__by_sandbox_batch",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("sandbox_classification_batch_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["id"],
            ["exercise_classification_chunk_creations.id"],
            name=op.f(
                "fk_exercise_classification_chunk_creations__by_sandbox_batch_id_exercise_classification_chunk_creations"
            ),
        ),
        sa.ForeignKeyConstraint(
            ...
            name=op.f(
                "fk_exercise_classification_chunk_creations__by_sandbox_batch_sandbox_classification_batch_id_sandbox_classification_batches"
            ),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_classification_chunk_creations__by_sandbox_batch")),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["exercise_class_id"],
            ["exercise_classes.id"],
            name=op.f("fk_exercise_classifications_exercise_class_id_exercise_classes"),
        ),
        sa.ForeignKeyConstraint(
            ["exercise_id"],
            ["exercises__adaptable.id"],
            name=op.f("fk_exercise_classifications_exercise_id_exercises__adaptable"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_classifications")),
    )
    op.create_table(
    ...
    op.create_table(
        "page_extractions",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("pdf_range_id", sa.Integer(), nullable=False),
        ...
        sa.Column("model_for_adaptation", sa.JSON(), nullable=True),
        sa.ForeignKeyConstraint(
            ["pdf_range_id"], ["pdf_file_ranges.id"], name=op.f("fk_page_extractions_pdf_range_id_pdf_file_ranges")
        ),
        sa.ForeignKeyConstraint(
            ["settings_id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["settings_id"],
            ["exercise_adaptation_settings.id"],
            name=op.f("fk_sandbox_adaptation_batches_settings_id_exercise_adaptation_settings"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["pdf_range_id"],
            ["pdf_file_ranges.id"],
            name=op.f("fk_sandbox_extraction_batches_pdf_range_id_pdf_file_ranges"),
        ),
        sa.ForeignKeyConstraint(
            ["settings_id"],
            ["extraction_settings.id"],
    ...
    op.create_table(
        ...
        sa.Column("at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["id"], ["exercise_adaptations.id"], name=op.f("fk_exercise_adaptation_creations_id_exercise_adaptations")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_adaptation_creations")),
    )
    op.create_table(
        "exercise_classification_chunk_creations__by_page_extraction",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["exercise_classification_chunk_creations.id"],
            name=op.f(
                "fk_exercise_classification_chunk_creations__by_page_extraction_id_exercise_classification_chunk_creations"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["page_extraction_id"],
            ["page_extractions.id"],
            name=op.f(
                "fk_exercise_classification_chunk_creations__by_page_extraction_page_extraction_id_page_extractions"
            ),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_classification_chunk_creations__by_page_extraction")),
    )
    op.create_table(
        "exercise_classifications__by_classification_chunk",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("classification_chunk_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["classification_chunk_id"],
            ["exercise_classification_chunks.id"],
            name=op.f(
                "fk_exercise_classifications__by_classification_chunk_classification_chunk_id_exercise_classification_chunks"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["id"],
            ["exercise_classifications.id"],
            name=op.f("fk_exercise_classifications__by_classification_chunk_id_exercise_classifications"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_classifications__by_classification_chunk")),
    )
    op.create_table(
        "exercise_classifications__by_user",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("username", sa.String(), nullable=False),
        sa.ForeignKeyConstraint(
            ["id"],
            ["exercise_classifications.id"],
            name=op.f("fk_exercise_classifications__by_user_id_exercise_classifications"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_classifications__by_user")),
    )
    op.create_table(
    ...
    op.create_table(
        "exercise_adaptation_creations__by_classification_chunk",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("classification_chunk_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["classification_chunk_id"],
            ["exercise_classification_chunks.id"],
            name=op.f(
                "fk_exercise_adaptation_creations__by_classification_chunk_classification_chunk_id_exercise_classification_chunks"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["id"],
            ["exercise_adaptation_creations.id"],
            name=op.f("fk_exercise_adaptation_creations__by_classification_chunk_id_exercise_adaptation_creations"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_adaptation_creations__by_classification_chunk")),
    )
    op.create_table(
        "exercise_adaptation_creations__by_sandbox_batch",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("sandbox_adaptation_batch_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["id"],
            ["exercise_adaptation_creations.id"],
            name=op.f("fk_exercise_adaptation_creations__by_sandbox_batch_id_exercise_adaptation_creations"),
        ),
        sa.ForeignKeyConstraint(
            ["sandbox_adaptation_batch_id"],
            ["sandbox_adaptation_batches.id"],
            name=op.f(
                "fk_exercise_adaptation_creations__by_sandbox_batch_sandbox_adaptation_batch_id_sandbox_adaptation_batches"
            ),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_adaptation_creations__by_sandbox_batch")),
    )
    op.create_table(
    ...
    op.create_foreign_key(
        op.f("fk_exercise_classes_latest_strategy_settings_id_exercise_adaptation_settings"),
        "exercise_classes",
        "exercise_adaptation_settings",
        ["latest_strategy_settings_id"],
        ["id"],
